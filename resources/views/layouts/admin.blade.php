				...
				<div class="navbar-content">
					<form class="search-form">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="navbarForm" placeholder="Search here{{asset('backend')}}.">
						</div>
					</form>
					<ul class="navbar-nav">
	...
	<div class="page-content">
        <div class="justify-content-between align-items-center grid-margin">
			...
			<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
				<p class="text-center text-muted text-md-left">Copyright © 2025 <a href="https://www.nobleui.com" target="_blank">Md.Tuhin Ahmed</a>. All rights reserved</p>
				<p class="mb-0 text-center text-muted text-md-left d-none d-md-block">T Ahmed With <i class="mb-1 ml-1 text-primary icon-small" data-feather="heart"></i></p>
			</footer>
			<!-- partial -->
